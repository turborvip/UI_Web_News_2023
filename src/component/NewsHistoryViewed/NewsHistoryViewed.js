...
import { getNewsWatched } from "../../ApiService";
    ...
    <div>
      {data && (
        <div className={styles.slider}>
          ...
          <Slider {...settings}>{renderSlides(dataWatched || data)}</Slider>
        </div>
      )}
    </div>
  );
